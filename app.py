...
st.markdown("""
<div class="hero">
    <div class="hero-eyebrow">AUTONOMOUS RESEARCH ENGINE</div>
...
with col_input:
    ...
    topic = st.text_input(
        "Research Query",
        placeholder="Ask ResearchMind to investigate a topic...",
        key="topic_input",
...
if st.session_state.running and not st.session_state.done:
    ...
    # ── Step 1: Search ──
    with st.spinner("🔍  Search Agent is fetching relevent sources…"):
...
st.markdown("""
<div class="notice">
    ResearchMind · Powered by LangChain multi-agent pipeline <br><hr style="margin:0.8rem 0;">
    BUILD with ❤️ by <b><u>Amit Kumar Rana</u></b>
</div>
""", unsafe_allow_html=True)